...
def test_rs_etf_backtest():
    ...
    payload = {
        ...
        "end_date": "2023-12-31",
        "main_index": "^NSEI",
        "custom_etfs": ["NIFTYBEES.NS", "BANKBEES.NS", "GOLDBEES.NS", "ITBEES.NS"],
        "total_capital": 5000000,
        "max_positions": 5,
        "risk_free_rate": 8.0
    }
    
    print(f"Sending backtest request for RS_ETF (with .NS tickers)...")
    try:
